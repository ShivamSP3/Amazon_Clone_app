...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void sellProducts(){
    ...
    adminServices.sellProducts(context: context,
        ...
        child: Form(
          ...
          child:Padding(
            ...
            child: Column(children: [
             ...
             items: images.map((i){
         return Builder(builder: (context) => Image.file(
          i,fit: BoxFit.cover
        , height: 200,),);
      }).toList(),
      ...
      options: CarouselOptions(
        viewportFraction: 1,height: 200
                ...
                child: DottedBorder(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 15,),
                      Text('Select Product Images',style: TextStyle(fontSize: 15,color: Colors.grey.shade400),)
                           ],)
                )),
              ),
              SizedBox(height: 25,),
              ...
              Container(
                ...
                child: Expanded(child: CustomButton(text: "Sell", onTap: sellProducts))),
                SizedBox(height: 10,)
            ],),
          ) ),
      ),
